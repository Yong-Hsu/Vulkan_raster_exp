/*
* Vulkan Example - Compute shader based rasterization
*/
...
public:
	...
	void prepareGraphics()
	{
		...
		shaderStages[0] = loadShader(getShadersPath() + "computeraster/texture.vert.spv", VK_SHADER_STAGE_VERTEX_BIT);
		shaderStages[1] = loadShader(getShadersPath() + "computeraster/texture.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
	...
	void prepareCompute()
	{
		...
		computePipelineCreateInfo.stage = loadShader(getShadersPath() + "computeraster/raster.comp.spv", VK_SHADER_STAGE_COMPUTE_BIT);
